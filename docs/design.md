...
- 验证面：入站和出站 MITM strategy 的 external/managed-process backend 均有真实 agent E2E，
  ...
  proxy-side policy hook、真实 TLS MITM data-plane verdict/audit 和 managed-process health-transition audit 的
...
| Enforcement | enforcement、transparent、MITM cases | user/root | dry-run、manifest reload、transparent lifecycle、MITM lifecycle 和 plaintext bridge。 | 内置 TLS MITM data-plane、proxy-side policy hook、trust/install lifecycle。 |
