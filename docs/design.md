...
| Enforcement | enforcement、transparent、MITM cases | user/root | dry-run、manifest reload、transparent lifecycle、MITM lifecycle、operator-managed client trust contract、plaintext bridge 和 proxy-side hook wiring。 | 内置 TLS MITM data-plane、proxy 内部动作执行、自动 client trust store 安装。 |
