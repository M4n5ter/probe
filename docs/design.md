...
- 默认/显式 live capture：
  ...
  - Missing：TLS lifecycle 缺口见 [Remaining TLS lifecycle gaps](#remaining-tls-lifecycle-gaps)；超出 bounded scan/sample 的 payload continuation、lost-event feedback 和完整 kernel-side capture program 仍未完成。
