...
pub use model::{
    ...
    ExporterTlsConfig, ExporterTransport, ExporterWorkerConfig, IngressJournalRetentionConfig,
    LibpcapCaptureConfig, LiveCaptureBackend, MAX_TLS_PLAINTEXT_RECONCILE_INTERVAL_MS,
