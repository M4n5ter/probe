...
impl CapabilityKind {
    pub fn wire_name(self) -> &'static str {
        match self {
            ...
            Self::PolicyRuntime => "policy_runtime",
            ...
            Self::FileExporter => "file_exporter",
            Self::UnixHttpExporter => "unix_http_exporter",
...
mod tests {
    ...
    fn capability_kind_wire_name_matches_json_name() -> Result<(), serde_json::Error> {
        for kind in [
            ...
            CapabilityKind::FileExporter,
            CapabilityKind::UnixHttpExporter,
