...
pub const EBPF_TLS_CALLS_MAP_NAME: &str = "TRAFFIC_PROBE_TLS_CALLS";
pub const EBPF_TLS_FDS_MAP_NAME: &str = "TRAFFIC_PROBE_TLS_FDS";
pub const EBPF_TLS_OFFSETS_MAP_NAME: &str = "TRAFFIC_PROBE_TLS_OFFSETS";
pub const EBPF_TLS_STATE_EPOCHS_MAP_NAME: &str = "TRAFFIC_PROBE_TLS_STATE_EPOCHS";
pub const EBPF_TLS_STATE_EPOCH_KEY: u32 = 0;
pub const EBPF_TLS_EVENT_SCRATCH_MAP_NAME: &str = "TRAFFIC_PROBE_TLS_EVENT_SCRATCH";
pub const EBPF_TLS_OUTPUT_LOSSES_MAP_NAME: &str = "TRAFFIC_PROBE_TLS_OUTPUT_LOSSES";
...
pub const EBPF_TLS_SSL_SET_FD_PROGRAM_NAME: &str = "traffic_probe_ssl_set_fd";
pub const EBPF_TLS_SSL_SET_FD_EXIT_PROGRAM_NAME: &str = "traffic_probe_ssl_set_fd_exit";
pub const EBPF_TLS_SSL_CLEAR_PROGRAM_NAME: &str = "traffic_probe_ssl_clear";
pub const EBPF_TLS_SSL_CLEAR_EXIT_PROGRAM_NAME: &str = "traffic_probe_ssl_clear_exit";
pub const EBPF_TLS_SSL_FREE_PROGRAM_NAME: &str = "traffic_probe_ssl_free";
pub const EBPF_TLS_SSL_READ_ENTER_PROGRAM_NAME: &str = "traffic_probe_ssl_read_enter";
pub const EBPF_TLS_SSL_READ_EXIT_PROGRAM_NAME: &str = "traffic_probe_ssl_read_exit";
pub const EBPF_TLS_SSL_WRITE_ENTER_PROGRAM_NAME: &str = "traffic_probe_ssl_write_enter";
pub const EBPF_TLS_SSL_WRITE_EXIT_PROGRAM_NAME: &str = "traffic_probe_ssl_write_exit";
pub const EBPF_TLS_SSL_READ_EX_ENTER_PROGRAM_NAME: &str = "traffic_probe_ssl_read_ex_enter";
pub const EBPF_TLS_SSL_READ_EX_EXIT_PROGRAM_NAME: &str = "traffic_probe_ssl_read_ex_exit";
pub const EBPF_TLS_SSL_WRITE_EX_ENTER_PROGRAM_NAME: &str = "traffic_probe_ssl_write_ex_enter";
pub const EBPF_TLS_SSL_WRITE_EX_EXIT_PROGRAM_NAME: &str = "traffic_probe_ssl_write_ex_exit";
