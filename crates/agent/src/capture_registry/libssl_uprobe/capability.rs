...
mod tests {
    ...
    fn capability_stays_degraded_until_stronger_lifecycle_guarantees_exist() {
        ...
        assert!(reason.contains("link-level target liveness beyond reconcile"));
