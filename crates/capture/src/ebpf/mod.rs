...
pub use ebpf_abi::{
    ...
    EBPF_PROCESS_OPTIONAL_TRACEPOINT_SPECS, EbpfProcessOptionalTracepointPairSpec,
...
pub use process_observation::{
    ...
    EbpfCloseTracepointObservation, EbpfConnectTracepointObservation, EbpfListenSocketLookup,
    EbpfObservedProcess, EbpfProcessHint, EbpfProcessObservation,
