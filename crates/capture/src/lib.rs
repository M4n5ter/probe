...
pub use tls::{
    ...
    LibsslUprobeAttachTargetId, LibsslUprobeDegradationReason, LibsslUprobeDiscoveryError,
    ...
    LibsslUprobePlaintextReconcile, LibsslUprobeProcessGenerationFailure, LibsslUprobeSymbol,
