...
- crate-level downstream/upstream TLS relay 不等于完整透明 HTTPS MITM；transparent rule-path
  end-to-end validation、ALPN-aware routing、hostname-to-upstream target routing、强原始归因和
  自动修改 trust store 仍是明确能力边界。
- 不隐藏长期保存原始流量。
